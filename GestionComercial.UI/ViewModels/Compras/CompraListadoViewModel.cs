...
{
    private ObservableCollection<CompraResumenDto> _compras = new();
    public ObservableCollection<CompraResumenDto> Compras
    {
        get => _compras;
    ...
    public CompraResumenDto CompraSeleccionada
    {
    ...
    private async Task CargarAsync()
    {
        ...
        try
        {
            // TODO: await _compraServicio.ObtenerAsync(filtros)
            await Task.Delay(200);
            Compras = new ObservableCollection<CompraResumenDto>();
            TotalCompras = 0;
            ComprasMostradas = 0;
        }
