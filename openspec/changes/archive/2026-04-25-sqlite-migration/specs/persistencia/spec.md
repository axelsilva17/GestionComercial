# Delta Spec: SQLite Migration - Persistencia
...
- [ ] No `Microsoft.EntityFrameworkCore.SqlServer` references remain
- [ ] All tests pass (`dotnet test`)
- [ ] Application creates SQLite database on first run
- [ ] All CRUD operations work correctly
- [ ] Seed data loads successfully
- [ ] Reports function with SQLite data source