...
namespace GestionComercial.Dominio.Interfaces.Servicios
{
    public interface IDescuentoConfiguracionServicio
    {
        ...
        Task ActualizarAsync(int id, string nombre, TipoDescuentoEnum tipo, decimal valor, int? idProducto, int? idCategoria, DateTime? fechaDesde, DateTime? fechaHasta, int prioridad);
